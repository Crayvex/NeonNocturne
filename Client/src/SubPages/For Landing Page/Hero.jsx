import { Compass, MenuIcon, MessageSquare, Send } from "lucide-react";
    ...
    <section id="Hero">
      <div className="left">
        <div className="flex items-center gap-2">
          <span className="rounded-full bg-purple-500 size-1.5 animate-pulse" />
          <p className="text-[10px] text-gray-200">PULSE SYSTEM V2.0 LIVE</p>
        </div>
        <div className="heading">
          <h1>COMMUNICATE</h1>
          <h1 className="text-heading">IN THE VOID.</h1>
        </div>
        ...
        <div className="btns">
          <a
            href="/login"
            className="bg-heading px-6 py-2 rounded-sm hover:scale-105 transition-transform"
          >
            GET STARTED
          </a>
      ...
      <div className="right">
        <div className="icons">
          ...
          <div className="">
            <img
              ...
              alt=""
              width={20}
              className="size-12 animate-pulse bg-purple-500 rounded-full flex justify-center items-center border-2 border-purple-400"
            />
          </div>
        </div>
        <div className="chat-area">
          ...
          <div className="flex flex-col min-w-md gap-4 mt-12 mb-4 text-sm">
            ...
            <div className="flex items-start md:justify-end w-full">
              <p className="bg-secondary rounded-2xl p-2 w-2xs">
          ...
          <div className="flex border-b border-cyan-200 py-2">
            <input
              type="text"
              readOnly
              placeholder="Message in #central-pulse"
              className="w-full bg-transparent outline-0 text-sm"
            />{" "}
            <Send className="text-heading" />{" "}
          </div>
        </div>
      </div>
    </section>
